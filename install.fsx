...
(**
[![Binder](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DiffSharp/diffsharp.github.io/blob/master/install.ipynb)&emsp;
...
(**
Tensors can be moved between devices (for example from CPU to GPU) using [Tensor.move](https://diffsharp.github.io/reference/diffsharp-tensor.html#move). For example:
